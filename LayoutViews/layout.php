...
<body style="background-color: #4CC9F0">
    ...
    <nav class="flex container mx-auto p-2 pl-0 h-36">
      ...
      <div class="hidden lg:flex space-x-24 items-center font-bold text-2xl text-black-500">
    ...
    mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row pb-12 bg-red-500"style="background-color: #B5179E">
